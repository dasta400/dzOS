...
\begin{document}
    ...
    \begin{longtable}{ |l|l|l|l|l| }\hline
        ...
        & \multicolumn{2}{|l|}{\textbf{System Variables}} & 359\\
        \hline
        \texttt{0x4184} & \texttt{0x421F} 
        & \multicolumn{2}{|l|}{\textbf{Reserved for future use}} & 153\\
        \hline
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \texttt{0x4184} - \textbf{VDP\_jiffy\_byte1} (1 byte):
            \hyperref[subsec:jiffy_counter]{Jiffy Counter}'s byte 1.
            \item \texttt{0x4185} - \textbf{VDP\_jiffy\_byte2} (1 byte):
            \hyperref[subsec:jiffy_counter]{Jiffy Counter}'s byte 2.
            \item \texttt{0x4186} - \textbf{VDP\_jiffy\_byte3} (1 byte):
    ...
    % ==========================================================================
        ...
        \begin{tabular}{l p{9cm}}
            ...
            \hline\textbf{Entry} & \texttt{A} = value used to initialise VDP's
            Register 1.\\
            \hline\textbf{Exit} & None\\
            \hline\textbf{Destroys} & \texttt{A}\\
            \hline\textbf{Calls} & None\\
        ...
        \begin{tabular}{l p{9cm}}
            \hline\textbf{Action}
            & Read the read-only Status Register. \textbf{IMPORTANT}: Reading
            the VDP Status Register clears (acknowledges) the VDP Interrupt.
            This is already done by the \textit{BIOS\_NMI} subroutine, so this
            function MUST not be used. It is only documented here for
            completeness.\\
            \hline\textbf{Entry} & None\\
    ...
    \begin{itemize}
        \item Remove century from year (e.g. $2022 - 2000 = 22$)
        \item Convert resulting number to hexadecimal (e.g. 22 = \texttt{0x0D})
    ...
    \begin{tabular}{ |m{1.3cm}m{1.3cm}m{2.2cm}|l|m{1.3cm}m{1.3cm}m{2.2cm}|>{\raggedleft\arraybackslash}m{2cm}| }
        ...
        \hline
        \hline
        0     & 1     & \texttt{0x00000200} & & 1     & 65    & \texttt{0x00008200} \\
        2     & 129   & \texttt{0x00010200} & & 3     & 193   & \texttt{0x00018200} \\
        4     & 257   & \texttt{0x00020200} & & 5     & 321   & \texttt{0x00028200} \\
        6     & 385   & \texttt{0x00030200} & & 7     & 385   & \texttt{0x00038200} \\
