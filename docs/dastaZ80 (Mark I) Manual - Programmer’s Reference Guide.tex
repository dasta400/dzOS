...
\begin{document}
    ...
    \begin{longtable}{ |l|l|l|l|l| }\hline
        ...
        \hline
        \multicolumn{2}{|c|}{\multirow{5}{*}{\textbf{CLI}}} & \texttt{0x40CE} & CLI\_buffer\_cmd & 16\\
        \multicolumn{2}{|c|}{} & \texttt{0x40DE} & CLI\_buffer\_parm1\_val & 16\\
        \multicolumn{2}{|c|}{} & \texttt{0x40EE} & CLI\_buffer\_parm2\_val & 16\\
        \multicolumn{2}{|c|}{} & \texttt{0x40FE} & CLI\_buffer\_pgm & 32\\
        \multicolumn{2}{|c|}{} & \texttt{0x411E} & CLI\_buffer\_full\_cmd & 64\\
        \hline
        \multicolumn{2}{|c|}{\multirow{9}{*}{\textbf{RTC}}} & \texttt{0x415E} & RTC\_hour & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x415F} & RTC\_minutes & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4160} & RTC\_seconds & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4161} & RTC\_century & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4162} & RTC\_year & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4163} & RTC\_year4 & 2\\
        \multicolumn{2}{|c|}{} & \texttt{0x4165} & RTC\_month & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4166} & RTC\_day & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4167} & RTC\_day\_of\_the\_week & 1\\
        \hline
        \multicolumn{2}{|c|}{\multirow{2}{*}{\textbf{Math}}} & \texttt{0x4168} & MATH\_CRC & 2\\
        \multicolumn{2}{|c|}{} & \texttt{0x416A} & MATH\_polynomial & 2\\
        \hline
        \multicolumn{2}{|c|}{\multirow{4}{*}{\textbf{Generic}}} & \texttt{0x416C} & SD\_status & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x416D} & tmp\_addr1 & 2\\
        \multicolumn{2}{|c|}{} & \texttt{0x416F} & tmp\_addr2 & 2\\
        \multicolumn{2}{|c|}{} & \texttt{0x4171} & tmp\_addr3 & 2\\
        \multicolumn{2}{|c|}{} & \texttt{0x4173} & tmp\_byte & 1\\
        \multicolumn{2}{|c|}{} & \texttt{0x4174} & tmp\_byte2 & 1\\
        \hline
    ...
    % ==========================================================================
        ...
        % ==========================================================================
        \subsubsection{F\_BIOS\_SD\_READ\_SEC}
        \label{func:fbiossdreadsec}
        % ==========================================================================
        \begin{tabular}{l p{9cm}}
            \hline\textbf{Action}
        ...
        % ==========================================================================
        \subsubsection{F\_BIOS\_SD\_WRITE\_SEC}
        \label{func:fbiossdwritesec}
        % ==========================================================================
        \begin{tabular}{l p{9cm}}
            \hline\textbf{Action}
    ...
    % ==========================================================================
        ...
        \begin{tabular}{l p{9cm}}
            ...
            \hline\textbf{Calls}
            & \hyperref[func:fbiossdreadsec]{F\_BIOS\_SD\_READ\_SEC}\\
            \hline
        \end{tabular}
        ...
        \begin{tabular}{l p{9cm}}
            ...
            \hline\multirow[t]{2}{4em}{\textbf{Calls}}
            & \hyperref[func:fkrnmultiply816slow]{F\_KRN\_MULTIPLY816\_SLOW}\\
            & \hyperref[func:fkrndzfssectortosd]{F\_KRN\_DZFS\_SECTOR\_TO\_SD}\\
            \hline
        \end{tabular}
        ...
        % ==========================================================================
        \subsubsection{F\_KRN\_DZFS\_FORMAT\_SD}
        \label{func:fkrndzfsformatsd}
        % ==========================================================================
        \begin{tabular}{l p{9cm}}
            \hline\textbf{Action}
        ...
        % ==========================================================================
        \subsubsection{F\_KRN\_DZFS\_SECTOR\_TO\_SD}
        \label{func:fkrndzfssectortosd}
        % ==========================================================================
        \begin{tabular}{l p{9cm}}
            \hline\textbf{Action}
            ...
            \hline\textbf{Calls}
            & \hyperref[func:fbiossdwritesec]{F\_BIOS\_SD\_WRITE\_SEC}\\
            \hline
        \end{tabular}
    ...
    \begin{itemize}
        ...
        * 32,768 bytes per Block = 33,3554,432 bytes (33 MB)
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Data Area} = 1024 Blocks (65,536 Sectors = 33,3554,432 bytes)
    \end{itemize}
