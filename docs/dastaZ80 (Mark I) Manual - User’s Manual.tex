...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Storage device
        \begin{itemize}
            \item Micro SD Card, formatted with FAT32 and containing image files
            formatted with DZFS\footnote{DZFS (dastaZ80 File System) is a file
            system of my own design, for mass storage devices, aimed at
            simplicity.}
        \end{itemize}
        \item Video output
        \begin{itemize}
        ...
        \begin{itemize}
            \item DS3231 RTC, provides valid until the year 2100 leap year compensation. 
        \end{itemize}
        \item Keyboard
        \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Create a file of 128 MB on the SD card. For example using Linux 
        terminal:  \texttt{fallocate -l \$((128*1024*1024)) dastaZ80.img}
    ...
    % ======================================================================
        ...
        \hspace{1.9cm}\textbf{$>$ setdate \textit{$<$dd$>$$<$mm$>$$<$yyyy$>$}}
        ...
        \hspace{1cm}\textbf{\textit{yyyy}}: year.

        \textbf{Example}: \texttt{$>$ setdate 22112022}
    ...
    % ==========================================================================
        ...
        \resizebox{12cm}{!}{
            \begin{tabular}{l l l l l l}
                ...
                \multicolumn{6}{l}{-----------------------------------------------------------------------------------}\\
                File & Created & Modified & Size & Attributes & Load Address\\
                \multicolumn{6}{l}{-----------------------------------------------------------------------------------}\\
                HelloWorld & 12-03-2022 13:21:44 & 12-03-2022 13:21:22 & 38 &
                E & 4420\\
                file2 & 11-05-2022 17:12:45 & 11-05-2022 18:21:32 & 512 & SE & 4420
            \end{tabular}
        }}
        ...
        \resizebox{12cm}{!}{
            \begin{tabular}{l l l l l l}
                ...
                File & Created & Modified & Size & Attributes & Load Address\\
                \multicolumn{6}{l}{-----------------------------------------------------------------------------------}\\
                \textasciitilde elloWorld & 12-03-2022 13:21:44 & 12-03-2022 13:21:22 & 38 &
                E & 4420\\
                file2 & 11-05-2022 17:12:45 & 11-05-2022 18:21:32 & 512 & SE & 4420
            \end{tabular}
        }}
        ...
        It overwrites the DZFS \textit{Superblock} and \textit{BAT}.
