...
\begin{document}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item After a few months of pause, I continue (sporadically though)
            with development of software (e.g. text editor, testing PSG, adding
            more commands to MS BASIC, and more).
        \end{itemize}
    \end{itemize}
